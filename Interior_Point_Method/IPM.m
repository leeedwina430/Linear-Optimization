function [x,y,s,iter,rtime,obj] = IPM(A,b,c)
% Solver for standard form LP: min c'*x, Ax=b, x>=0
% Using Predictor-Corrector Interior Point Method
%
% Input:
%   A - m*n Full Row Rank Matrix; Equality Constraints' Coefficient
...
%
% File Describition:
%      IPM: Direct Implementation of Alg 14.3
%      IPM_cho: Using inbuilt function "cho()" for Standard Cholesky Decomposition
